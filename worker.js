...
.instagram-card{display:block;text-decoration:none;border:1px solid rgba(236,220,203,.12);border-radius:16px;overflow:hidden;background:#fff;color:#171717}
.instagram-card-head{display:flex;align-items:center;gap:10px;padding:12px 14px;background:#fff}
.instagram-avatar{width:34px;height:34px;border-radius:50%;display:grid;place-items:center;background:#171319;color:#fff;font:700 10px Arial,sans-serif;letter-spacing:.05em;flex:0 0 auto}
.instagram-card-head strong{display:block;font-size:13px;line-height:1.2}.instagram-card-head small{display:block;color:#777;font-size:11px;margin-top:2px}.instagram-view{margin-left:auto;color:#405de6;font-size:12px;font-weight:700}
.instagram-card img{width:100%;aspect-ratio:1/1;object-fit:cover;background:#111}
.instagram-card-foot{padding:12px 14px;font-weight:700;font-size:12px;color:#405de6;background:#fff}
.instagram-fallback{display:block;padding:24px;border:1px solid var(--line);border-radius:14px;text-decoration:none;color:var(--accent)}
@media(max-width:620px){.instagram-card{border-radius:12px}.instagram-card img{aspect-ratio:auto;max-height:none;object-fit:contain;background:#000}}
