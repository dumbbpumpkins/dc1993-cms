...
async function handleApi(request, env, url) {
  ...
  if (path === "/api/admin/settings" && request.method === "POST") {
    ...
    const allowed = [
      ...
      "updates_eyebrow","updates_heading","updates_text","instagram_heading","instagram_post_url_1","instagram_post_url_2","instagram_post_url_3","footer_text"
    ];
    const stmts = [];
...
const safeInstagramUrl=u=>{const raw=String(u??"").trim();if(!raw)return"";try{const x=new URL(raw);let host=x.hostname.toLowerCase();if(host.startsWith("www."))host=host.slice(4);if(host!=="instagram.com")return"";const parts=x.pathname.split("/").filter(Boolean);if(!["p","reel","tv"].includes(parts[0]||""))return"";return x.href}catch{return""}};
...
<div class="grid"><div class="full"><label>Small heading</label><input id="updates_eyebrow" type="text"></div><div class="full"><label>Heading</label><input id="updates_heading" type="text"></div><div class="full"><label>Text</label><textarea id="updates_text"></textarea></div><div class="full"><hr><h2 style="font-size:24px">Featured Instagram</h2><p class="hint">Paste any public Instagram post or Reel URL. Leave it blank to hide the Instagram section completely.</p></div><div class="full"><label>Instagram section heading</label><input id="instagram_heading" type="text"></div><div class="full"><label>Featured Instagram post 1</label><input id="instagram_post_url_1" type="url" placeholder="https://www.instagram.com/p/..."></div><div class="full"><label>Featured Instagram post 2</label><input id="instagram_post_url_2" type="url" placeholder="https://www.instagram.com/p/..."></div><div class="full"><label>Featured Instagram post 3</label><input id="instagram_post_url_3" type="url" placeholder="https://www.instagram.com/p/..."></div></div>
