...
.instagram-embed-crop{width:100%;overflow:hidden;max-height:760px}
.instagram-embed-crop .instagram-media{margin:0!important}
@media(max-width:620px){.instagram-embed-crop{max-height:1080px}}
...
.home-feature{padding:82px 0 72px;gap:52px}
.home-shelf{min-height:340px;padding:0 0 4px}
.home-paths{padding:8px 0 20px}
.home-path{padding:30px 4px}
.updates{margin:46px 0 30px}
@media(max-width:900px){
...
@media(max-width:620px){
  .home-feature{padding:52px 0 44px;gap:18px}
  .home-shelf{min-height:220px;margin-top:2px}
  .home-paths{padding:0 0 10px}
  .home-path{padding:24px 0}
  .updates{margin:34px 0 24px}
}
</style></head>
