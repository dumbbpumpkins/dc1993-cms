...
async function handleApi(request, env, url) {
  ...
  if (path === "/api/admin/settings" && request.method === "POST") {
    ...
    const allowed = [
      ...
      "updates_eyebrow","updates_heading","updates_text","instagram_heading","instagram_post_url","footer_text"
    ];
    const stmts = [];
...
<section class="instagram-feature" id="instagramFeature" hidden><div class="instagram-head"><p class="eyebrow">SOCIAL</p><h2 id="instagramHeading">Latest from Instagram</h2></div><div class="instagram-embed-wrap" id="instagramEmbedWrap"></div></section>`;
